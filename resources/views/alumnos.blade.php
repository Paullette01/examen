        ...
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl mt-10 mt:mt-0">
            <form action="{{route('alumnos.store')}}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input name="apellidos" type="text" placeholder="Apellidos del alumno" required>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input name="fecha_nacimiento" type="date" placeholder="Fecha de nacimiento del alumno" required>
                </div>
